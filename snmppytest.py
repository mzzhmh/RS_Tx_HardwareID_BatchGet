...
session = Session(hostname='10.13.17.57', community='public', version=2)
SN = session.get('.1.3.6.1.2.1.47.1.1.1.1.11.1')
SW = session.get('.1.3.6.1.2.1.47.1.1.1.1.9.1')
print(SN.value)
print(SW.value)

session2 = Session(hostname='10.15.200.151', community='public', version=2)
SN2 = session2.get('.1.3.6.1.2.1.47.1.1.1.1.11.1')
SW2 = session2.get('.1.3.6.1.2.1.47.1.1.1.1.9.1')
print(SN2.value)
print(SW2.value)

session3 = Session(hostname='10.15.200.152', community='public', version=2)
